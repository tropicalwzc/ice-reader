# ios-browser-upload-server Specification

## Purpose
Define the foreground iOS HTTP service and secure browser workflow for importing novels from computers on the same local network without desktop server software.
## Requirements
